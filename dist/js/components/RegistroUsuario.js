app.component('registro-usuario', {
    props: {
        name: {
            type: String
        }
    ...
    template:
        ...
        <p class="page-title text-center">Registro de Usuario</p>
                    ...
                    <form action="response.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-4 mt-4 margin-content title-medium text-center">
                            ...
                            <div class="form-group display-forms">
                                <label for="nombre-usuario" class="col-md-4 d-flex space-register">Nombre de usuario:</label>
                                <div class="col-md-5">
